...
const REVIEWS = {
  1: {
    ...
    author: USERS[1],
    rating: 7,
    text: 'Stunning views, great location, lovely staff.',
  },
  2: {
    id: 2,
    date: '14 July, 2021',
    author: USERS[2],
    rating: 9.1,
    text: 'Gorgeous hotel, very clean, staff were very helpful and friendly. Great location, would definitely stay again!',
  },
};
...
export const TOP_PLACES = [
  {
    id: 1,
    image: require('../../assets/images/trips/halong.jpg'),
    title: 'Ha Long Bay',
    location: 'VietNam',
    description:
      'Hạ Long Bay is a UNESCO World Heritage Site in Vietnam, known for its stunning natural beauty of thousands of limestone islands and islets rising from emerald waters.',
    rating: 9.4,
    gallery: [
      require('../../assets/images/trips/halong1.jpg'),
      require('../../assets/images/trips/halong3.jpg'),
    ],
